      ...
      <div className={`flex w-full ${activeIndex === 1 ? "flex-row-reverse" : ""}`}>
        ...
        <AnimatePresence mode="popLayout" custom={direction}>
          <motion.div
            ...
            exit="exit"
            transition={{ duration: 0.3, ease: "easeInOut" }}
            className="hidden lg:flex lg:w-1/2 bg-gray-50 relative overflow-hidden items-center justify-center min-h-screen"
          >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center px-12 py-16 text-center">
              <div className="w-20 h-20 bg-white rounded-[2rem] shadow-2xl flex items-center justify-center mb-8 text-purple-600 rotate-12">
                <Sparkles size={40} />
              </div>
