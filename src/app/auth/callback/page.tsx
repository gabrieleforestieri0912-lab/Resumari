    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-zinc-950">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <h2 className="text-xl font-black text-gray-900 dark:text-gray-100 mb-2">Accesso fallito</h2>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-zinc-950">
      <div className="text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Accesso in corso...</p>
      </div>
    </div>
  );
}
