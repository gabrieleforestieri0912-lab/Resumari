...
describe('GET /api/mcp/oauth/config', () => {
  it('exposes the OAuth discovery metadata', async () => {
    ...
    expect(body.issuer).toBe('https://test.resumari.com')
    expect(body.authorization_endpoint).toBe('https://test.resumari.com/api/mcp/oauth/authorize')
    expect(body.token_endpoint).toBe('https://test.resumari.com/api/mcp/oauth/token')
